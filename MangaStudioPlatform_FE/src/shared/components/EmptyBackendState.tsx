        ...
        <div className="flex max-w-md flex-col items-start gap-4 sm:flex-row">
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-6 text-slate-400">
              {emptyDescription ??
                "New items will appear here when they are available to your workspace."}
            </p>
            <div className="mt-4 flex flex-wrap gap-3">
              {onRefresh ? (
                <button
                  type="button"
                  onClick={onRefresh}
                  className="inline-flex items-center gap-2 rounded-lg border border-cyan-300/30 bg-cyan-300/10 px-3 py-2 text-sm font-semibold text-cyan-100 hover:bg-cyan-300/15"
                >
                  <RefreshCw size={15} />
                  Refresh
                </button>
